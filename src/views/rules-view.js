			...
			<main id="rules">
				...
				<section class="columns">
					...
					<ol>
						...
						<li>
							<p><strong>Last of its kind</strong> (<em>Hu juezhang</em>, <span class="fanzhong" data-src="58">和绝张</span>): winning on the last (fourth) tile of its kind. All four tiles must be on the floor, openly melded, or in the winning hand.</p>
						</li>
					</ol>
				</section>
				<section class="columns">
