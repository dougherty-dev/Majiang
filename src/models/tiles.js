...
const ZIPAI = quadruple([
	['a', 'zi1', 'dong', '东', '🀀', 'zipai-fengpai-1-dong', 'f'],
	['b', 'zi2', 'nan', '南', '🀁', 'zipai-fengpai-2-nan', 'f'],
	['c', 'zi3', 'xi', '西', '🀂', 'zipai-fengpai-3-xi', 'f'],
	['d', 'zi4', 'bei', '北', '🀃', 'zipai-fengpai-4-bei', 'f'],
	['a', 'zi5', 'zhong', '中', '🀄︎', 'zipai-jianpai-1-zhong', 'j'],
	['b', 'zi6', 'fa', '发', '🀅', 'zipai-jianpai-2-fa', 'j'],
	['c', 'zi7', 'bai', '白', '🀆', 'zipai-jianpai-3-bai', 'j'],
], 108)
