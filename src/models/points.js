...
export default class Points {
	...
	setupCommon() {
		...
		this.struct.openMelds = melds.filter(item => item.type !== 'angang')
	}
	...
	setupFanzhong() {
		this.fanzhong = {
			// 88 fan
			'1': ['大四喜', 'Da si xi', 'Big four winds', fz1DaSiXi, 0, [9, 13, 14, 16, 29, 38, 49, 60, 61, 63, 73]],
			'2': ['大三元', 'Da san yuan', 'Big three dragons', fz2DaSanYuan, 0, [10, 13, 14, 16, 29, 54, 59, 63]],
			...
			'11': ['字一色', 'Zi yi se', 'All honors', fz11ZiYiSe, 0, [13, 14, 16, 29, 49, 55, 63, 73]],
			...
			// 6 fan
			'49': ['碰碰和', 'Pengpeng hu', 'All kezi', fz49PengpengHu, 0, [63]],
